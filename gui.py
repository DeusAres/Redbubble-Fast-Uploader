...
def work(driver, ctitle="", ctags="", cdesc="", vtitle="", vtags="", vdesc=""):
    ...
    # PARSE PRODUCT DATAS FOR UPLOAD OR EXPORT SETTINGS
    ...
    # PARSE ENABLED FOR CHANGE AND PASS IT TO FILE TO PRODUCE
    ...
    while True:
        ...
        if event == 'IMPORTTEXT':
            if values['IMPORTTEXT'] != '':
                with open(values['IMPORTTEXT'], 'r') as out:
        ...
        if event == 'EXPORTTEXT':
            if values['EXPORTTEXT'] != '':
                textDict = {
                    "CTITLE" : values['CTITLE'],
                    "CDESC" : values['CDESC'],
                    "CTAGS" : values['CTAGS'],
                }
                with open(values['EXPORTTEXT'], 'w') as out:
